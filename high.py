...
# /Users/coltenparker/Downloads/Image-to-roblox/high.py
with open("/Users/coltenparker/Downloads/Image-to-roblox/output/output_file.txt", "w") as f:
    f.write("High processing result")

factor = 3.2  # Rate of change to resolution 1: Original resolution. ie: 640x640 - 6.4 - 100x100
rate = 50    # Rate that parts are created at
